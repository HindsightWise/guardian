...
1.  **Locate Session**: Execute `run_shell_command("/Users/zerbytheboss/Desktop/OpenClaw/openclaw/tools/pickle-rick/scripts/get_session.sh")` to find the session root.
2.  **Filename**: `prd.md`.
