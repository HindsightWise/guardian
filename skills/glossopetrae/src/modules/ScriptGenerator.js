...
export class ScriptGenerator {
  ...
  _selectScriptType() {
    return this.random.weightedPick([
      ...
      ["abugida", 0.2], // Consonant base + vowel diacritics
      ["syllabary", 0.2], // One character per syllable
  ...
  _selectDirection() {
    const dir = this.random.weightedPick([
      ...
      ["rtl", 0.2], // Right to left (Arabic, Hebrew)
  ...
  _generateNumerals() {
    ...
    return {
      base: system,
      baseValue: { decimal: 10, vigesimal: 20, duodecimal: 12, sexagesimal: 60, quinary: 5 }[
        system
      ],
      representation,
